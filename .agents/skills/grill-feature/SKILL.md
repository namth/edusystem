...
name: grill-feature
description: >-
  Kích hoạt Quy trình Phỏng vấn & Tài liệu hóa Tính năng Mới (Grill Feature Protocol).
  Thực thi quy trình phỏng vấn từng câu hỏi một để làm rõ yêu cầu tính năng mới, phân tích tác động DB/API và xuất file tài liệu spec trong docs/features/.
---
