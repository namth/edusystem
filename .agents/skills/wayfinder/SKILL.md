...
name: wayfinder
description: >-
  Kích hoạt Quy trình Định vị & Khoanh vùng Mã nguồn (Wayfinder Protocol).
  Định vị chính xác danh sách file mục tiêu (Target Files), file ngữ cảnh (Context Files) và xuất Location Report trước khi sửa đổi code.
---
